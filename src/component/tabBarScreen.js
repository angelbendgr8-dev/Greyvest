      ...
      renderTabBar={props => (
        <TabBar
          ...
          renderLabel={({route, focused, color}) => (
            <Text style={{...Fonts.gray12Medium}}>{route.title}</Text>
          )}
        />
      )}
    />
...
const WatchList = ({navigation}) => {
  ...
  const [listData, setListData] = useState(WatchlistData);
  ...
  const renderItem = data => (
    <TouchableHighlight style={{...styles.rowFront}} activeOpacity={0.9}>
      <TouchableOpacity
        activeOpacity={0.9}
        style={{
        ...
        <View style={styles.currencyInfoContainerStyle}>
          <View style={{flexDirection: 'row', alignItems: 'center'}}>
            ...
            <View style={{marginLeft: Sizes.fixPadding}}>
              ...
              <View
                ...
                <AntDesign
                  name={data.item.isPositive == true ? 'caretup' : 'caretdown'}
                  size={12}
                  color={
                    data.item.isPositive == true ? Colors.primaryColor : 'red'
                  }
          ...
          <View>
            <Text style={{...Fonts.black16SemiBold}}>${data.item.amount}</Text>
          </View>
        </View>
      </TouchableOpacity>
    </TouchableHighlight>
    ...
    <View style={styles.rowBack}>
      <TouchableOpacity
        ...
        <Animated.View
          ...
          />
          <Text style={{...Fonts.white13Medium, alignSelf: 'center'}}>
            Delete
          </Text>
        </Animated.View>
      </TouchableOpacity>
